 ...
 */
package com.carreras.controllers.impl;
 ...
 */
public class CompetenciaControllerImplOrig extends CompetenciaController {
    ...
    public void eventoCarril(RespuestaEvent respuestaEvent) {
        if (respuestaEvent.getDatos().getTipo() == Datos.CARRIL) {
            ...
            CarrerasLogger.info(getClass(), "hubo adelantamiento");
            adelantamientoCarril(respuestaEvent);
        } else if (respuestaEvent.getDatos().getTipo() == Datos.ROTURA) {
            CarrerasLogger.info(getClass(), "hubo roturas que");
    ...
    private void tiemposCarril(final RespuestaEvent respuestaEvent) {
        try {
            ...
            CarrerasLogger.info(getClass(), "actualizando tiempos de carril: " + carrilDatos.getNro_carril());
